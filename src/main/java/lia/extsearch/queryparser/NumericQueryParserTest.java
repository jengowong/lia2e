    ...
    static class NumericRangeQueryParser extends QueryParser {
        ...
        public Query getRangeQuery(String field,
            ...
            TermRangeQuery query =
                    (TermRangeQuery) super.getRangeQuery(field, part1, part2, inclusive); // A
            if ("price".equals(field)) {
                return NumericRangeQuery.newDoubleRange(          // B
                        "price",                                  // B
                        Double.parseDouble(query.getLowerTerm()), // B
                        Double.parseDouble(query.getUpperTerm()), // B
...
*/
    ...
    public static class NumericDateRangeQueryParser extends QueryParser {
        ...
        public Query getRangeQuery(String field,
                                   ...
                                   boolean inclusive) throws ParseException {
            TermRangeQuery query =
                    (TermRangeQuery) super.getRangeQuery(field, part1, part2, inclusive);
