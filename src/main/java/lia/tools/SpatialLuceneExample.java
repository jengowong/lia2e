...
public class SpatialLuceneExample {
    ...
    private void addLocation(IndexWriter writer,
                             String name,
                             double lat,
        ...
        doc.add(new Field(
                latField,
                NumericUtils.doubleToPrefixCoded(lat),  // #A
                Field.Store.YES,
                Field.Index.NOT_ANALYZED));             // #A
        doc.add(new Field(
                lngField,
                NumericUtils.doubleToPrefixCoded(lng),  // #A
                Field.Store.YES,
                Field.Index.NOT_ANALYZED));             // #A
...
*/
    ...
    public void findNear(String what,
                         double latitude,
                         double longitude,
        ...
        dsort = new DistanceFieldComparatorSource(dq.getDistanceFilter()); // #C
